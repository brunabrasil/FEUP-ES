...
import 'package:uni/model/presence_page_model.dart';
import 'package:uni/view/Pages/register_presence_page_view.dart';
import 'package:uni/model/request_page_model.dart';
        ...
        child: MaterialApp(
            ...
            onGenerateRoute: (RouteSettings settings) {
              switch (settings.name) {
                ...
                case '/' + Constants.navPresence:
                  return PageTransition.makePageTransition(
                      page: PresencePage(), settings: settings);
                case '/' + Constants.navAbcenses:
                  return PageTransition.makePageTransition(
                      page: AbsencePage(), settings: settings);
                case '/' + Constants.navRegisterPresence:
                  return PageTransition.makePageTransition(
                      page: RequestPage(), settings: settings);
